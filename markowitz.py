...
from metrics import (annualized_adjusted_rate, beta_bb, expected_return, rate_array, volatility)
...
class Stock(object):
    ...
    def __init__(self, symbol, startdate="2000-01-01",
        enddate="2013-01-01", dbfilename='data/stocks.db', bench='LALDX', rfr=0.015):
        ...
        self.bench_data = data_processors.load_from_db(bench,
                                        self.startdate,
                                        self.enddate,
                                        dbfilename=dbfilename)
        self.stock_data = data_processors.load_from_db(symbol,
                                        self.startdate,
                                        self.enddate,
                                        dbfilename=dbfilename)
...
class Portfolio(object):
    ...
    def level_lengths(self):
        ...
        latest_start_date = np.datetime64("2000-1-1")
        symbs = self.symbols
        s = self.stocks
